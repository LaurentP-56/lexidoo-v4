                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <th>Nom</th>
                                    <th>Prénom</th>
                                    <th><a href="{{ route('admin.users.index', ['sortBy' => 'email', 'sortDirection' => request('sortDirection', 'desc') == 'asc' ? 'desc' : 'asc']) }}">Email</a></th>
                                    <th><a href="{{ route('admin.users.index', ['sortBy' => 'created_at', 'sortDirection' => request('sortDirection', 'desc') == 'asc' ? 'desc' : 'asc']) }}">Inscrit Le</a></th>
                                    <th><a href="{{ route('admin.users.index', ['sortBy' => 'premium', 'sortDirection' => request('sortDirection', 'desc') == 'asc' ? 'desc' : 'asc']) }}">Premium</a></th>
                                </tr>
                                </tr>
                                </thead>
                                <tbody>
